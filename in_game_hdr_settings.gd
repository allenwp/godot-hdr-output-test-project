...
func _process(_delta: float) -> void:
	...
	var adjustment_step_2 = 0.3
	var adjustment_step_3 = 0.4
	...
	var max_adjust_material_value = pow(2.0, (log(max_lum) / log(2.0)) - adjustment_step_3)
	...
	max_adjust_material_value = pow(2.0, (log(max_lum) / log(2.0)) + adjustment_step_3)
